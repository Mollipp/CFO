"""
Generate the complete AI-Native Morning Cockpit prototype dataset.
...
from src.generators.generate_bank_daily_signals import (
    generate_bank_daily_signals,
    read_bank_history,
    validate as validate_daily_signals,
)
from src.generators.generate_news_signals import generate_news_datasets
from src.generators.generate_treasury_portfolio import generate_treasury_datasets
from src.generators.generate_peer_financials import generate_peer_datasets
from src.generators.generate_strategic_radar import generate_strategic_radar
...
def generate_all(
    ...
    """
    Generate every CSV required by the AI-Native Morning Cockpit prototype.
    ...
    print("=" * 72)
    print("AI-NATIVE MORNING COCKPIT -- GENERATE ALL DATA")
    print("=" * 72)
    ...
    print("\nAll AI-Native Morning Cockpit datasets generated successfully.")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate all AI-Native Morning Cockpit prototype datasets."
    )
    parser.add_argument(
        "--output-dir",
        default="data",
    ...
    parser.add_argument("--history-seed", type=int, default=20260826)
